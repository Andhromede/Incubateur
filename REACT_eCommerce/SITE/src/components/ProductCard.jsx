                        ...
                        <div className="bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700 inline-block mt-8 mr-8 h-110 w-96" key={item.id_produit} >
                            ...
                            <div className="px-5 pb-5">
                                ...
                                <div className="flex justify-between items-center pt-5">
                                    ...
                                    <a href="#" className="flex text-white bg-emerald-700 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800">
                                        <span className="mr-1">Ajouter au</span>
                                        <FaShoppingBasket className="mt-1"/>
                                    </a>

                                    {/* <a href="#" className="flex text-white bg-orange-700 hover:bg-orange-800 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-orange-600 dark:hover:bg-orange-700 dark:focus:ring-orange-800">
